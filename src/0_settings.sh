...
# the exported Prometheus DB folder path, this is only for debugging.
...
# Parent directory of this Git repo folder, automatically updated by script 1_init_and_start_pipeline.sh.
